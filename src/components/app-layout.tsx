...
const nav: NavItem[] = [
  ...
  { to: "/agenda", label: "Agenda y tareas", icon: CalendarDays },
  { to: "/pagos", label: "Pagos", icon: CreditCard, adminOnly: true },
  { to: "/importaciones", label: "Importaciones", icon: CloudDownload },
  { to: "/revision-ia", label: "Revisión de IA", icon: BrainCircuit },
