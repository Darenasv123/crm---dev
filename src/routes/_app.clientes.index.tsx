...
function ClientsPage() {
  ...
  }, [caseFilter, page, searchInput, specialtyFilter, statusFilter]);
  ...
  const filtered = useMemo(() => {
    return clients.filter((client) => {
      ...
      return matchSearch && matchStatus && matchSpecialty && matchCaseFilter;
    });
  }, [caseFilter, casesByClient, clients, paymentsByClient, search, specialtyFilter, statusFilter]);
    ...
    <AppLayout
      ...
      actions={
        <div className="flex items-center gap-2">
          ...
          {/* Botón unificado de importación */}
          <div className="relative">
            <button
              ...
              aria-label="Opciones de importación"
              className="inline-flex items-center gap-2 h-10 px-3 rounded-lg bg-card border border-border text-sm font-medium hover:bg-muted/60 transition"
            >
            ...
            {showImportMenu && (
              <>
                ...
                <div
                  role="menu"
                  className="absolute right-0 top-full z-50 mt-1 w-64 rounded-xl border border-border bg-card shadow-lg py-1"
                >
                  <button
                    type="button"
                    role="menuitem"
                    ...
                    className="flex w-full items-center gap-3 px-4 py-2.5 text-sm hover:bg-muted/60 transition"
                  >
                    <FolderOpen className="h-4 w-4 shrink-0 text-muted-foreground" />
                    <div className="text-left">
                      <div className="font-medium">Importar carpeta</div>
                      <div className="text-[11px] text-muted-foreground">
                        Carpeta con documentos del cliente
                      </div>
                    </div>
                  </button>
                  <button
                  ...
                  >
                    ...
                    <div className="text-left">
                      <div className="font-medium">Importar cliente desde ZIP</div>
                      <div className="text-[11px] text-muted-foreground">
                        Archivo ZIP con expediente completo
                      </div>
                    </div>
                  </button>
                  <button
                  ...
                  >
                    ...
                    <div className="text-left">
                      <div className="font-medium">Importar lista CSV/XLSX</div>
                      <div className="text-[11px] text-muted-foreground">
                        Hoja de cálculo con múltiples clientes
                      </div>
                    </div>
                  </button>
                </div>
